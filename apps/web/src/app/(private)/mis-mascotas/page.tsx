    ...
    <Card elevated>
      <CardHeader className="items-start">
        ...
        <CardDescription className="max-w-2xl">
          Crea la primera ficha para guardar sus datos, identificación y
          fotografías. Más adelante podrás vincularla a reportes de pérdida.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Link
          href="/mis-mascotas/nueva"
          className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-primary px-5 text-base font-semibold text-white transition-colors hover:bg-primary-hover focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/20"
        >
  ...
  return (
    <Card elevated>
      <CardHeader>
        ...
        <CardDescription>
          Inténtalo de nuevo dentro de unos instantes. Tus datos permanecen
          protegidos.
        </CardDescription>
      </CardHeader>
    </Card>
      ...
      <Card className="h-full transition-[border-color,box-shadow,transform] duration-150 group-hover:-translate-y-0.5 group-hover:border-primary/30 group-hover:shadow-[var(--shadow-md)]">
        <CardHeader>
          <div className="flex items-start justify-between gap-4">
            ...
            <span
              className={`rounded-full px-3 py-1 text-xs font-semibold ${statusClasses[pet.status]}`}
            >
