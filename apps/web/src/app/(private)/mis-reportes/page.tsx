...
async function loadOwnReports() {
  ...
  return { reports, petNames: new Map(pets.map((pet) => [pet.id, pet.name])), photoUrls };
}

export default async function MyReportsPage({ searchParams }: { searchParams: Promise<{ estado?: string }> }) {
