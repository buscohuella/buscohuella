  ...
  return (
    <>
      ...
      <PageContainer className="space-y-6 pt-2">
        ...
        <Card><CardHeader><ShieldCheck className="mb-3 size-8 text-primary" aria-hidden="true" /><CardTitle>{translate('profile.page.privacyTitle')}</CardTitle><CardDescription>{translate('profile.page.privacyDescription')}</CardDescription></CardHeader></Card>
      </PageContainer>
    </>
  );
}
