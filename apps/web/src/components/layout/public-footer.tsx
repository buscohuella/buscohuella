      ...
      <PageContainer className="py-10 sm:py-14">
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-footer-border pt-5 text-xs text-footer-muted sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            <nav className="flex gap-3" aria-label={translate('footer.legalTitle')}>
              <Link href="/legal/privacidad" className="underline-offset-4 transition-colors hover:text-primary hover:underline active:text-primary active:underline focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-focus-soft">{translate('footer.privacyLink')}</Link>
              <Link href="/legal/terminos" className="underline-offset-4 transition-colors hover:text-primary hover:underline active:text-primary active:underline focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-focus-soft">{translate('footer.termsLink')}</Link>
              <Link href="/legal/cookies" className="underline-offset-4 transition-colors hover:text-primary hover:underline active:text-primary active:underline focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-focus-soft">{translate('footer.cookiesLink')}</Link>
            </nav>
          </div>
