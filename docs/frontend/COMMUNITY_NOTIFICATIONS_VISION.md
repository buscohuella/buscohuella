...
3. notificación interna de nuevo avistamiento;
4. mapa y autocompletado;
5. filtros y alertas básicas;
6. push por proximidad;
7. chat contextual;
8. seguimiento de avisos;
9. grupos de búsqueda;
10. integraciones profesionales e institucionales.
